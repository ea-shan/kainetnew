...
function TrustItem({
  ...
  return (
    <span className="inline-flex items-center gap-1.5">
      <span className="flex size-4 shrink-0 items-center justify-center text-[var(--kai-lavender)]" aria-hidden>
        {icon}
      </span>
      <span>{label}</span>
    </span>
...
export function HeroSection() {
  return (
    <section
      className="relative -mt-[76px] flex min-h-[calc(100dvh+76px)] flex-col justify-center pt-[100px] pb-4 text-[var(--kai-white)] min-[768px]:pt-[108px] min-[768px]:pb-6"
    >
      <HeroMosaic />
      <div className="relative z-10 mx-auto w-full max-w-[1600px] px-5 min-[768px]:px-10">
        <div className="relative w-full max-w-[640px]">
          ...
          {/* <div className="mt-5 flex max-w-[420px] items-center gap-2.5">
            <span
              className="flex size-8 shrink-0 items-center justify-center rounded-full border border-[#d3a7d9]/55 text-[var(--kai-lavender)]"
              aria-hidden
            >
              <LockIcon className="size-3.5" />
            </span>
            <p className="text-[14px] leading-[1.45] tracking-[0.01em]">
              <span className="text-[var(--kai-white)]/88">Every campaign is </span>
              <span className="font-semibold text-[var(--kai-grad-pink)]">built paused.</span>
              <span className="mt-0.5 block text-[13px] text-[var(--kai-lavender)]/70">
          ...
          <div className="mt-8 inline-flex max-w-full flex-col gap-4">
            ...
            <div className="flex flex-nowrap items-center gap-x-3 text-[12px] leading-[1.4] text-[var(--kai-white)]/72 max-[640px]:flex-wrap max-[640px]:gap-y-2">
