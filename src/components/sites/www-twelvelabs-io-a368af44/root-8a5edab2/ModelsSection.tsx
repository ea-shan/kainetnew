...
export function ModelsSection() {
  return (
    <section className="bg-[#000000] px-5 py-20 text-[var(--kai-white)] md:px-10">
      <div className="tl-page grid grid-cols-1 gap-8 md:grid-cols-2 md:gap-x-12 lg:gap-x-20">
        ...
        <div className="max-w-[520px] border-l border-white/15 pl-6">
          <p className="text-[16px] leading-6 tracking-[0.16px] text-[var(--kai-white)]/80">
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3">
                <Icon className="size-9 text-[var(--kai-white)]" />
