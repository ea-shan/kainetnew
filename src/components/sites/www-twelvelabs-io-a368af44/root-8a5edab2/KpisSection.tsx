...
export function KpisSection() {
  return (
    <section className="bg-[#F4F3F3] px-5 pb-10 pt-16 text-[#1D1C1B] min-[768px]:px-10">
      <div className="tl-page">
        ...
        <div className="tl-kpis mt-16 grid min-[768px]:grid-cols-3 min-[768px]:divide-x min-[768px]:divide-[#1D1C1B]/12">
          {kpis.map((kpi) => (
