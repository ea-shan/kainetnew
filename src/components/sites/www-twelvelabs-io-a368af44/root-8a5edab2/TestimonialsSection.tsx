...
export function TestimonialsSection() {
  ...
  return (
    <section
      className="w-full overflow-hidden py-20 text-[#1D1C1B]"
      style={{
        background: "linear-gradient(90deg, #d8efb0 0%, #f5edd8 48%, #f3d6e8 100%)",
      }}
    >
        ...
        <div className="tl-stories-track">
          {loop.map((item, i) => (
            ...
            >
              ...
              <p className="mt-auto pt-10 text-[12px] uppercase tracking-[0.08em] text-[#1D1C1B]/55">
                {item.name} {item.role}
              </p>
            </article>
          ))}
